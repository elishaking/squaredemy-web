            ...
            <a href="https://web.facebook.com/skyblazar" target="_blank" rel="noreferrer noopener">
              <svg id="facebook_176_" data-name="facebook [#176]" xmlns="http://www.w3.org/2000/svg" width="0.5em" height="1em" viewBox="0 0 16.145 32.289">
                <g id="Dribbble-Light-Preview">
                  <g id="icons">
                    <path id="facebook-_176_" data-name="facebook-[#176]" d="M340.012,7271.29v-14.53h4.412l.72-6.458h-5.132v-3.148c0-1.662.044-3.309,2.367-3.309h2.354v-4.617a26.589,26.589,0,0,0-4.067-.227c-4.272,0-6.947,2.68-6.947,7.588v3.713H329v6.458h4.719v14.53Z" transform="translate(-329 -7239)" fill="#fff" fill-rule="evenodd" />
                  </g>
                </g>
              </svg>
            </a>
